      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="flex items-start gap-2 mt-0.5">
          <textarea
            ...
            onBlur={save}
            rows={2}
            className="flex-1 resize-none bg-neutral-100 rounded-lg px-2 py-1 text-[13px] text-neutral-800 focus:outline-none focus:bg-neutral-200 transition-colors leading-snug"
          />
          <button
  ...
  return (
    <div className="flex-1 min-w-0">
      ...
      <button
        ...
        className="group flex items-start gap-2 w-full text-left mt-0.5 px-2 py-1.5 -mx-2 rounded-lg hover:bg-neutral-100 transition-colors"
      >
        ...
        <HiOutlinePencil className="w-3.5 h-3.5 text-neutral-400 shrink-0 mt-0.5" aria-hidden="true" />
      </button>
    </div>
  )
}
