...
The same gate also performs a real browser catalog search and attachment
download, builds strict C11 and C++20 projects, and delegates a second C11
project to native Codex. Technical acceptance leaves UI review pending.
